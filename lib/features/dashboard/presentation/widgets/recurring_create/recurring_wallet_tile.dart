                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${'recurring_wallet_balance'.tr(ref)}: ${AppConstant.formatMoney(selectedWallet!.balance, selectedWallet!.currencyCode)} ${_getCurrencySymbol(selectedWallet!.currencyCode)}',
                          style: TextStyle(

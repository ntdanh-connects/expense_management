...
import 'package:expense_management/features/wallet/presentation/widget/dashed_border_painter.dart';
import 'package:expense_management/features/wallet/presentation/widget/transfer_history_shimmer.dart';
import 'package:expense_management/features/wallet/presentation/widget/simple_qr_scanner_page.dart';
                        ...
                        if (index < displayedWallets.length) {
                          ...
                          return Padding(
                            ...
                            child: WalletCardItem(
                              ...
                              onTap: () =>
                                  context.push('/add-wallet', extra: wallet),
                            ),
                          );
                        } else {
                                    ...
                                    onPressed: () async {
                                      final qrString =
                                          await Navigator.push<String>(
                                            ...
                                            MaterialPageRoute(
                                              builder: (_) =>
                                                  const SimpleQrScannerPage(),
                                            ),
                                          );
                                      if (qrString != null) {
                                        final extracted =
                                            _extractIdentifierFromQr(qrString);
                                ...
                                child: TextField(
                                  ...
                                  onChanged: (val) {
                                    ...
                                    if (amt != null) {
                                      ...
                                      final formatted = _formatMoney(
                                        amt,
                                        'VND',
                                      );
                                      _externalAmountController
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    final mappedPayee = {
                                      ...
                                      'identifier': _payeeIdentifierController
                                          .text
                                          .trim(),
                                      ...
                                      'from_wallet_id':
                                          _selectedExternalSourceWallet!.id,
                                      'amount': amount,
                                      'description':
                                          _externalNotesController.text
                                              .trim()
                                              .isNotEmpty

...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  void _checkAndShowWalkthrough() {
    ...
    if (user != null) {
      ...
      if (storage.needsNewUserSetup(user.id) && !storage.hasSeenWalkthrough(user.id)) {
        ...
        return Transform.scale(
          ...
          child: FadeTransition(
            ...
            child: Align(
              ...
              child: _WalkthroughDialogContent(colors: colors, isDark: isDark),
            ),
          ),
        );
      },
...
class _WalkthroughDialogContent extends ConsumerStatefulWidget {
  final AppColorsExtension colors;
  final bool isDark;

  const _WalkthroughDialogContent({
    required this.colors,
    required this.isDark,
  });

  @override
  ConsumerState<_WalkthroughDialogContent> createState() =>
      __WalkthroughDialogContentState();
}

class __WalkthroughDialogContentState
    extends ConsumerState<_WalkthroughDialogContent> {
